...
export default function Home() {
  return (
    <Flex gap="middle" wrap>
      <Layout >
        <Header className="bg-white flex justify-between border-b-[1px]">
          <Link href="/">
            <img src="/insight/my-app/src/app/assets/icons/logo.svg" alt="logo" />
          </Link>
          <div>
        ...
        <Content className="bg-white pl-[30px] pr-[30px]">
        ...
        <Footer className="bg-white border-t-[1px] flex justify-between">
          ...
          <div>
            ...
            <p className="text-[#5c5c5c] w-[300px] mt-[20px]">*Суд признал экстремистской и запретил в России
            деятельность корпорации Meta по реализации социальных сетей</p>
          </div>
        </Footer>
      </Layout>
    </Flex>
